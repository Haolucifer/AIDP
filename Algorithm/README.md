...
<img src='imgs/inception_1.png' width="600px"/>
...
<img src='imgs/inception_2.png' width="600px"/>
...
<img src='imgs/inception_5.png' width="200px"/>

接着，GoogLeNet又考虑是否可以以更小的卷积操作来代替3x3卷积呢，因此，他们又设计出如图下图所示的卷积，即用3个3x1代替一个3x3卷积。

<img src='imgs/inception_6.png' width="200px"/>
...
<img src='imgs/MobileNet_1.png' width="400px"/>
...
<img src='imgs/MobileNet_3.png' width="400px"/>
...
<img src='imgs/ResNet_3.png' width="400px"/>
...
<img src='imgs/ResNet_4.png' width="400px"/>
...
<img src='imgs/ResNet_5.png' width="400px"/>
...
<img src='imgs/VGG_1.png' width="400px"/>
...
<img src='imgs/VGG_2.png' width="400px"/>

## **VGGNet结构**

VGGNet的结构如下图所示，它共有五个结构相似，差异不大的网络模型。

<img src='imgs/VGG_3.png' width="400px"/>

 以VGG16为例，简化其网络结构图如下：
 
 <img src='imgs/VGG_4.png' width="300px"/>
