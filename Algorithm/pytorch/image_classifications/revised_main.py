...
parser.add_argument('-dp','--data_path', default='/root/Datasets/my-data/', metavar='DIR',
...
_,_,num_classes = get_number_of_classification(args.data_path + '/train/')
print(num_classes)
...
def main_worker(gpu, ngpus_per_node, args):
    ...
    for epoch in range(args.start_epoch, args.epochs):
        ...
        save_path = args.saved_model_path + '/' + args.arch + '_checkpoint.pth.tar'
        save_checkpoint({
            'epoch': epoch + 1,
            'arch': args.arch,
...
def save_checkpoint(state, is_best, filename='checkpoint.pth.tar'):
    ...
    if is_best:
        ...
        shutil.copyfile(filename, path + '/' + args.arch + '_model_best.pth.tar')
